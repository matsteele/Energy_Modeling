...
import {caretCreator} from "./caret.js";
...
class PromptInput extends Component {
  ...
  componentDidMount(){
    ...
    this.setState({displayOptionsArray: this.state.initialOptionsArray});
  }
  ...
  async handleSubmit(e){
    ...
    await this.props.shiftToNextSequence(this.state.sequenceToChangeTo);

    this.findDataBasedOnSequenceAndChangeState(this.props.sequence)

    this.props.shiftToWriting("notWriting");
